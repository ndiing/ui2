...
class AppChipsElement extends MDElement{
    ...
    constructor(){
        ...
        this.list1=[
            ...
            {avatar:'https://api.dicebear.com/8.x/icons/svg?seed=Abby&scale=70',label:'Label 6'},
            {avatar:'https://api.dicebear.com/8.x/icons/svg?seed=Abby&scale=70',label:'Label 7'},
            {avatar:'https://api.dicebear.com/8.x/icons/svg?seed=Abby&scale=70',label:'Label 8'},
            {avatar:'https://api.dicebear.com/8.x/icons/svg?seed=Abby&scale=70',label:'Label 9'},
            {avatar:'https://api.dicebear.com/8.x/icons/svg?seed=Abby&scale=70',label:'Label 10'},
        ]
