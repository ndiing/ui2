...
class DevMain extends MDElement {
    constructor() {
        ...
        this.list = [
            {
                nodeIcons:['deployed_code','deployed_code'],label: "app-bar",
                children: [
            ...
            {
                nodeIcons:['deployed_code','deployed_code'],label: "button",
                children: [
            ...
            {
                nodeIcons:['deployed_code','deployed_code'],label: "navigation",
                children: [
            ...
            {
                nodeIcons:['deployed_code','deployed_code'],label: "sheet",
                children: [
            ...
            {
                nodeIcons:['deployed_code','deployed_code'],label: "uncategorized",
                children: [
