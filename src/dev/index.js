...
const routes = [
    {
        ...
        children: [
            ...
            { path: "auth", load: () => import("./auth/auth.js").then((m) => m.default) },
            { path: "badge", load: () => import("./badge/badge.js").then((m) => m.default) },
            { path: "blog", load: () => import("./blog/blog.js").then((m) => m.default) },
            { path: "blogs", load: () => import("./blogs/blogs.js").then((m) => m.default) },
            ...
            { path: "data", load: () => import("./data/data.js").then((m) => m.default) },
            ...
            { path: "register", load: () => import("./register/register.js").then((m) => m.default) },
            ...
            { path: "user", load: () => import("./user/user.js").then((m) => m.default) },
            { path: "users", load: () => import("./users/users.js").then((m) => m.default) },
