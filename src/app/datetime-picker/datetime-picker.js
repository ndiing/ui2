                ...
                <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium4 md-layout-column__item--compact4">
                    <md-datetime-picker
                        ...
                        @onDatetimePickerChange="${(event) => {
                            button1.label=[
                                [
                                    dateTimePicker1.selected.getFullYear(),
                                    dateTimePicker1.selected.getMonth()+1,
                                    dateTimePicker1.selected.getDate(),

                                ].join('-')
                                ,[
                                    dateTimePicker1.selected.getHours(),
                                    dateTimePicker1.selected.getMinutes(),
                                ].join(':')
                            ].join('T')
                        }}"
                ...
                <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium4 md-layout-column__item--compact4">
                    <md-datetime-picker
                        ...
                        @onDatetimePickerChange="${(event) => {
                            button1.label=[
                                [
                                    dateTimePicker2.selected.getFullYear(),
                                    dateTimePicker2.selected.getMonth()+1,
                                    dateTimePicker2.selected.getDate(),

                                ].join('-')
                                ,[
                                    dateTimePicker2.selected.getHours(),
                                    dateTimePicker2.selected.getMinutes(),
                                ].join(':')
                            ].join('T')
                        }}"
