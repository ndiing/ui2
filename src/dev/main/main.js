...
class DevMain extends MDElement {
    constructor() {
        ...
        this.list = [
            ...
            { leafIcon: "deployed_code", label: "app-bar", children:[
            ...
            { leafIcon: "deployed_code", label: "button", children:[
            ...
            { leafIcon: "deployed_code", label: "navigation", children:[
            ...
            { leafIcon: "deployed_code", label: "sheet", children:[
            ...
            { leafIcon: "deployed_code", label: "uncategorized", children:[
