...
function langToLocale(langCode) {
    // Create a mapping of language codes to locale formats
    const langLocaleMap = {
        id: "id-ID", // Indonesian
    ...
    // Check if the provided language code exists in the mapping
    if (langLocaleMap.hasOwnProperty(langCode)) {
        return langLocaleMap[langCode];
    } else {
        // If no matching locale found, return the input as it is
        return langCode;
    }
}
...
// console.log(locale); // Output: "id-ID"
    ...
    render() {
        ...
        return html`
            <div class="md-date-picker__header">
                ...
                ${this.index==2||this.index==1?html`
...
export { MDDatePicker, langToLocale };
