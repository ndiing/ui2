...
class AppTextareaFieldElement extends MDElement {
    render() {
        return html`
            <md-form
...
customElements.define("app-textarea-field", AppTextareaFieldElement);

export default document.createElement("app-textarea-field");
