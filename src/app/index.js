...
const routes = [
    {
        ...
        children: [
            {
                path: "layout",
                load: () => import("./layout/layout.js").then((m) => m.default),
            },
            {
                path: "typography",
                load: () =>
            ...
            {
                path: "image",
                load: () => import("./image/image.js").then((m) => m.default),
            },
            {
                path: "icon",
                load: () => import("./icon/icon.js").then((m) => m.default),
            },
            {
                path: "ripple",
                load: () => import("./ripple/ripple.js").then((m) => m.default),
            },
            {
                path: "popper",
                load: () => import("./popper/popper.js").then((m) => m.default),
            },
            {
                path: "virtual-scroll",
                load: () =>
            ...
            {
                path: "form",
                load: () => import("./form/form.js").then((m) => m.default),
            },
            {
                path: "checkbox",
                load: () =>
            ...
            {
                path: "switch",
                load: () => import("./switch/switch.js").then((m) => m.default),
            },
            {
                path: "badge",
                load: () => import("./badge/badge.js").then((m) => m.default),
            },
            {
                path: "fab",
                load: () => import("./fab/fab.js").then((m) => m.default),
            },
            {
                path: "button",
                load: () => import("./button/button.js").then((m) => m.default),
            },
            {
            ...
            {
                path: "card",
                load: () => import("./card/card.js").then((m) => m.default),
            },
            {
                path: "dialog",
                load: () => import("./dialog/dialog.js").then((m) => m.default),
            },
            {
                path: "side-sheet",
                load: () =>
            ...
            {
                path: "menu",
                load: () => import("./menu/menu.js").then((m) => m.default),
            },
            {
                path: "tooltip",
                load: () =>
            ...
            {
                path: "tabs",
                load: () => import("./tabs/tabs.js").then((m) => m.default),
            },
            {
            ...
            {
                path: "chips",
                load: () => import("./chips/chips.js").then((m) => m.default),
            },
            {
                path: "slider",
                load: () => import("./slider/slider.js").then((m) => m.default),
            },
            {
