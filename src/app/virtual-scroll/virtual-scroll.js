            ...
            <div class="md-layout-column" style="margin:24px;">
                <div class="md-layout-column__item md-layout-column__item--expanded12 md-layout-column__item--medium4 md-layout-column__item--compact4">
                    <div id="viewport" style="width: calc(56px * 5);height: calc(56px * 5);" @onVirtualScrollChange="${this.handleVirtualScrollChange}">
                        ...
                        <md-list id="container" .list="${this.list}" .singleSelection="${true}" @onListItemClick="${this.handleListItemClick}" @onListItemSelected="${this.handleListItemSelected}"></md-list>
                    </div>
                </div>
            </div>
        `;
