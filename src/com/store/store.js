...
//     .then(console.log)
//     .catch(console.error);
// localStore.get("1").then(console.log).catch(console.error);
// localStore.patch("1", { website: "google.com" }).then(console.log).catch(console.error);
// localStore.delete("1").then(console.log).catch(console.error);
// localStore
//     .getAll({
//         _sort: "name,username",
//         _order: "desc,asc",
...
class RemoteStore {
    ...
    async getAll(options = {}) {
        return fetch(this.url.href, {
            ...
            const count = response.headers.get("x-total-count"); //X-Total-Count
            if (count) {
...
// const remoteStore = new RemoteStore("https://jsonplaceholder.typicode.com/", {
//     post: "/posts",
//     get: "/posts/:_id",
//     patch: "/posts/:_id",
//     delete: "/posts/:_id",
...
// remoteStore.sort("id", "desc");
// remoteStore.sort("title", "asc");
// remoteStore.sort("title", "desc");
// // remoteStore.sort('title','')
// // remoteStore.sort()

// remoteStore.search("lorem");
// remoteStore.search("ipsum");
// remoteStore.search("ipsum dolor");
// remoteStore.search("sit amet");
// // remoteStore.search('')
// // remoteStore.search()

// remoteStore.paginate(1, 10);
// // remoteStore.paginate(1)
// // remoteStore.paginate()

// remoteStore.slice(0, 10);
// // remoteStore.slice(0)
// // remoteStore.slice()

// remoteStore.filter("name", "value");
// remoteStore.filter("name", "");
// remoteStore.filter("name", "value", "_gt");
// remoteStore.filter("name", "", "_gt");
// remoteStore.filter("name", "value", "_lt");
// // remoteStore.filter("name", "", "_lt");

// remoteStore.filter("age", 17, "_lt");
// remoteStore.filter("age", 17, "_gt");
// remoteStore.filter("age", 17, "_eq");
// // remoteStore.filter("age", "", "");
...
// //     .then(console.log)
// //     .catch(console.error);
// // store.get(1).then(console.log).catch(console.error);
// // store
// //     .patch(1, {
// //         userId: 1,
// //         id: 1,
...
// //     .then(console.log)
// //     .catch(console.error);
// // store.delete(1).then(console.log).catch(console.error);
// store
// .search('lorem')
// .getAll()
// .then(response=>{
