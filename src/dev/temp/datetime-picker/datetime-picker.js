...
class MDDateTimePicker extends MDElement {
    ...
    constructor() {
        ...
        this.hourDTF = new Intl.DateTimeFormat(this.locale, { hour: "numeric", hour12: false });
        this.minuteDTF = new Intl.DateTimeFormat(this.locale, { minute: "numeric" });
        this.labelDTF = new Intl.DateTimeFormat(this.locale, { year: "numeric", month: "long" });
        this.label2DTF = new Intl.DateTimeFormat(this.locale, { hour:'2-digit',minute:'2-digit',hour12:false });
