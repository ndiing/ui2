"use strict";(self.webpackChunk_ndiinginc_material=self.webpackChunk_ndiinginc_material||[]).push([[4115],{4115:(e,m,t)=>{t.r(m),t.d(m,{default:()=>a});var l=t(6684),d=t(283);class o extends d.z{render(){return l.qy`
            <md-form
        ...
        `}handleFormNativeReset(e){console.log(e)}handleFormNativeSubmit(e){console.log(JSON.stringify(e.detail.data,null,4))}}customElements.define("dev-text-field2",o);const a=document.createElement("dev-text-field2")}}]);