const attributesData = [
    {
        ...
        type: ["all"],
        except: ["url", "email", "password"],
    },
    {
        attribute: "autocomplete",
        type: ["all"],
        except: ["checkbox", "radio", "button"],
    },
    ...
    { attribute: "form", type: ["all"], except: [] },
    {
        attribute: "list",
        type: ["all"],
        except: ["hidden", "password", "checkbox", "radio", "button"],
    },
    ...
    },
    {
        attribute: "required",
        type: ["all"],
        except: ["hidden", "range", "color", "button"],
    },
    ...
    {
        attribute: "dirname",
        type: ["hidden", "text", "search", "url", "tel", "email"],
        except: [],
    },
    {
        attribute: "max",
